...
var schemer = {
    ...
    normalize_model_schema: function(model_schema){
        ...
        /*console.log("Lodash output schema == "+JSON.stringify(output_schema))*/
        ...
        for(k in output_schema.fields){
            if (typeof (output_schema.fields[k]) == 'string' )
                ...
                //console.log(output_schema.fields[k])
                if(output_schema.fields[k] == null){
                    /*console.log("null found")*/
                    output_schema.fields[k] = {"type":"timeuuid"}
                    /*console.log("After null change == "+JSON.stringify(output_schema))*/
                }
                else if(output_schema.fields[k].virtual){
